...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'guzzle.cache.provider' => 'getGuzzle_Cache_ProviderService',
    ...
    {
        $this->services['csa_guzzle.client.addons_api'] = $instance = new \GuzzleHttp\Client(array('base_url' => 'https://api-addons.prestashop.com', 'timeout' => '5.0', 'headers' => array('Accept' => 'application/json')));
    ...
    {
        return $this->services['csa_guzzle.subscriber.cache'] = new \Csa\Bundle\GuzzleBundle\GuzzleHttp\Subscriber\CacheSubscriber(new \Csa\Bundle\GuzzleBundle\GuzzleHttp\Cache\DoctrineAdapter($this->get('guzzle.cache.provider'), 7200));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'selive', 'user' => 'root', 'password' => '', 'charset' => 'UTF8', 'driverOptions' => array(), 'serverVersion' => 5.0999999999999996), new \Doctrine\DBAL\Configuration(), $a, array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_debff52ff79888bb62d12cc4ecfbbfd850876553cbc11da53f0f994f074a3053');
    ...
    {
        return $this->services['form.type.product.seo'] = new \PrestaShopBundle\Form\Admin\Product\ProductSeo($this->get('translator.default'), $this->get('prestashop.adapter.legacy.context'));
    }
    ...
    {
        return $this->services['form.type.typeahead.product'] = new \PrestaShopBundle\Form\Admin\Type\TypeaheadProductCollectionType($this->get('prestashop.adapter.data_provider.product'));
    }
    ...
    {
        return new \Csa\Bundle\GuzzleBundle\GuzzleHttp\Cache\DoctrineAdapter($this->get('guzzle.cache.provider'), 7200);
    }

    /*
     * Gets the 'guzzle.cache.provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getGuzzle_Cache_ProviderService()
    {
        return $this->services['guzzle.cache.provider'] = new \Doctrine\Common\Cache\FilesystemCache((__DIR__.'/guzzle'));
    }
    ...
    {
        return $this->services['locale_listener'] = new \Symfony\Component\HttpKernel\EventListener\LocaleListener($this->get('request_stack'), 'ru-RU', $this->get('router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['prestashop.adapter.data_provider.category'] = new \PrestaShop\PrestaShop\Adapter\Category\CategoryDataProvider();
    }
    ...
    {
        return $this->services['prestashop.adapter.legacy.configuration'] = new \PrestaShop\PrestaShop\Adapter\Configuration($this->get("prestashop.adapter.legacy.context")->getContext()->shop);
    }
    ...
    {
        $this->services['prestashop.addons.client_api'] = $instance = new \PrestaShopBundle\Service\DataProvider\Marketplace\ApiClient($this->get('csa_guzzle.client.addons_api'), $this->get("prestashop.adapter.legacy.context")->getContext()->language->iso_code, $this->get("prestashop.adapter.data_provider.country")->getIsoCodebyId());

        $instance->setSslVerification(($this->targetDirs[3].'/app/cache/prod\\cacert.pem'));
    ...
    {
        $this->services['prestashop.core.admin.data_provider.addons_interface'] = $instance = new \PrestaShop\PrestaShop\Adapter\Addons\AddonsDataProvider($this->get('prestashop.addons.client_api'));
    ...
    {
        return $this->services['prestashop.core.admin.data_provider.module_interface'] = new \PrestaShop\PrestaShop\Adapter\Module\AdminModuleDataProvider($this->get("prestashop.adapter.legacy.context")->getEmployeeLanguageIso(), $this->get('prestashop.router'), $this->get('prestashop.core.admin.data_provider.addons_interface'), $this->get('prestashop.categories_provider'));
    }
    ...
    {
        return $this->services['prestashop.core.admin.module.repository'] = new \PrestaShop\PrestaShop\Core\Addon\Module\ModuleRepository($this->get('prestashop.core.admin.data_provider.module_interface'), $this->get('prestashop.adapter.data_provider.module'), $this->get('prestashop.core.module.updater'), $this->get('prestashop.adapter.legacy.logger'), $this->get('translator.default'));
    }
    ...
    {
        return $this->services['prestashop.module.manager'] = new \PrestaShop\PrestaShop\Core\Addon\Module\ModuleManager($this->get('prestashop.core.admin.data_provider.module_interface'), $this->get('prestashop.adapter.data_provider.module'), $this->get('prestashop.core.module.updater'), $this->get('prestashop.core.admin.module.repository'), $this->get('prestashop.module.zip.manager'), $this->get('translator.default'), $this->get("prestashop.adapter.legacy.context")->getContext()->employee);
    }
    ...
    {
        return $this->services['prestashop.tokenized_url_listener'] = new \PrestaShopBundle\EventListener\TokenizedUrlsListener($this->get('security.csrf.token_manager'), $this->get('prestashop.router'), $this->get("prestashop.user_provider")->getUsername(), $this->get("prestashop.adapter.legacy.context")->getContext()->employee);
    }
    ...
    {
        return $this->services['prestashop.twig.extension.admin'] = new \PrestaShopBundle\Twig\AdminExtension($this->get('request_stack'));
    }
    ...
    {
        return $this->services['prestashop.twig.extension.hook'] = new \PrestaShopBundle\Twig\HookExtension($this->get('prestashop.hook.dispatcher'), $this->get('prestashop.adapter.data_provider.module'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'PrestaShopBundle:Admin/TwigTemplateForm:bootstrap_3_horizontal_layout.html.twig'), 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape' => 'filename', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('uDo0k7IAFOBeNKxTER1bevB4YTUQOOg4ZA8uGiEw5FNGQOiqwUpSayY1');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58558d7aa02936.65288224')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'uDo0k7IAFOBeNKxTER1bevB4YTUQOOg4ZA8uGiEw5FNGQOiqwUpSayY1',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2016-12-17',
            'locale' => 'ru-RU',
            'cookie_key' => '0OaGcfNEdWSNJ9xLXTmJoaIWPrv4FYJS0HPYjCN1QXWioLx3QsJooae6',
            'cookie_iv' => 'z5BLCCaC',
            'new_cookie_key' => 'def00000b22efa4cedc3f11cd973cee9e26a9011347882585b1a281e5009886f49f9a1eeb7005dd9463299f20695f011b18b5c1b5b5943ad7fbdaa87aa9e49fe5efba6a5',
            ...
            'kernel.secret' => 'uDo0k7IAFOBeNKxTER1bevB4YTUQOOg4ZA8uGiEw5FNGQOiqwUpSayY1',
            ...
            'prestashop.addons.api_client.verify_ssl' => ($this->targetDirs[3].'/app/cache/prod\\cacert.pem'),
